  ...
  return (
    <div className="retro-card mb-4">
      <div className="flex flex-wrap items-start justify-between gap-2">
        ...
        <span className="text-xs text-paper-muted dark:text-terminal-muted">{job.period}</span>
      </div>
      <div className="text-xs text-paper-muted dark:text-terminal-muted mt-0.5 mb-4">{job.location}</div>

      <div className="space-y-4 border-t border-paper-border dark:border-terminal-border pt-4">
